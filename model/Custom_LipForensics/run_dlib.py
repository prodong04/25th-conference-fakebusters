...
sys.path.insert(0, "./roi_extractor/dlib")
from dlib_preprocess import VideoROIExtractor
import os
import cv2
...
def main():
    ...
    parser.add_argument("--save_video", action='store_true', help="Flag to save cropped mouth video. Default is False.")
    #parser.add_argument("--config_path", type=str, required=True, help="Path to the configuration YAML file.")
    args = parser.parse_args()

    # Config 파일 읽기
    with open('./roi_extractor/dlib/dlib_config.yaml', 'r', encoding='utf-8') as file:
