...
def construct_cached_mm_representations(args):
    ...
    for dname in args['datasets']:
        ...
        for label in labels:   
            ...
            #path = os.path.join(args['mm_root'], 'original', 'mm_representation.pth')
            mm_representation = torch.load(root)
            #mm_representation = torch.load('/home/dongryeol/frame_diffusion_detection/MM_Det/outputs/mm_representations/0_real/original/mm_representation.pth')
