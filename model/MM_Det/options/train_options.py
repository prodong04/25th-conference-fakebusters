...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--split-ratio', type=int, nargs='+', default=[0.8, 0.2], help='the split ratio for train and validation if split is not specified')
        ...
        self.parser.add_argument('--lr', type=float, default=1e-4, help='lr')
        self.parser.add_argument('--weight-decay', type=float, default=1e-6, help='weight decay')
        self.parser.add_argument('--patience', type=int, default=5, help='patience')
        self.parser.add_argument('--cooldown', type=int, default=3, help='cool down')
        self.parser.add_argument('--step-factor', type=float, default=0.4, help='step factor for lr adjustment')
        ...
        self.parser.add_argument('--display-step', type=int, default=10, help='display steps')
        ...
        self.parser.add_argument('--val-bound', type=float, default=1e-8, help='the minimum value for validation metric to finish training')
